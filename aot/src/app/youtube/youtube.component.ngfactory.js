...
export var View_YoutubeComponent0 = (function (_super) {
    ...
    View_YoutubeComponent0.prototype.createInternal = function (rootSelector) {
        ...
        this._NgModel_18_5 = new import11.Wrapper_NgModel(null, null, null, this._NG_VALUE_ACCESSOR_18_4);
        ...
        this._vc_139 = new import13.ViewContainer(139, null, this, this._el_139);
        this._RouterOutlet_139_5 = new import15.Wrapper_RouterOutlet(this.parentView.injectorGet(import20.RouterOutletMap, this.parentIndex), this._vc_139.vcRef, this.parentView.injectorGet(import21.ComponentFactoryResolver, this.parentIndex), null);
        ...
        var disposable_1 = import3.subscribeToRenderElement(this, this._el_18, new import3.InlineArray8(8, 'ngModelChange', null, 'keypress', null, 'blur', null, 'input', null), this.eventHandler(this.handleEvent_18));
    ...
    View_YoutubeComponent0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        ...
        if (((token === import24.NgModel) && (18 === requestNodeIndex))) {
            return this._NgModel_18_5.context;
        }
        if (((token === import25.NgControl) && (18 === requestNodeIndex))) {
            return this._NgControl_18_6;
        }
        if (((token === import26.NgControlStatus) && (18 === requestNodeIndex))) {
            return this._NgControlStatus_18_7.context;
        }
        if (((token === import18.TemplateRef) && (107 === requestNodeIndex))) {
            return this._TemplateRef_107_5;
        }
        if (((token === import27.NgFor) && (107 === requestNodeIndex))) {
            return this._NgFor_107_6.context;
        }
        if (((token === import28.RouterOutlet) && (139 === requestNodeIndex))) {
...
var View_YoutubeComponent1 = (function (_super) {
    ...
    View_YoutubeComponent1.prototype.createInternal = function (rootSelector) {
        ...
        this._query_RouterLink_2_0 = new import31.QueryList();
        this._query_RouterLinkWithHref_2_1 = new import31.QueryList();
        this._text_3 = this.renderer.createText(this._el_2, '\n                        ', null);
    ...
    View_YoutubeComponent1.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        ...
        if (((token === import37.RouterLinkWithHref) && ((2 <= requestNodeIndex) && (requestNodeIndex <= 14)))) {
            return this._RouterLinkWithHref_2_3.context;
        }
        if (((token === import38.RouterLinkActive) && ((2 <= requestNodeIndex) && (requestNodeIndex <= 14)))) {
